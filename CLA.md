# Heliopause Contributor License Agreement

**Harmony Individual|Entity Contributor License Agreement, Version 1.0**

This document adopts the Harmony Combined Contributor Agreement Template
Version 1.0 (July 4, 2011), available at
<https://www.harmonyagreements.org/docs/ha-combined-v1>. Heliopause selects
the **Copyright License** form, not Copyright Assignment, and selects
**Outbound License Option Five**. The project-specific submission instructions
are in `CONTRIBUTING.md`.

The Harmony template is used as the canonical basis under its stated Creative
Commons Attribution 3.0 Unported terms; this file only fills project identity,
selects the copyright-license/Option Five variants, and links the project
third-party contribution procedure.

Thank you for your interest in contributing to Heliopause (`rahoney/heliopause`)
("We" or "Us"). This contributor agreement ("Agreement") documents the
rights granted by contributors to Us. It is legally binding; read it carefully
and obtain independent legal advice where appropriate. It may cover successor
software projects managed by Us.

## 1. Definitions

"You" (Individual) means the individual who Submits a Contribution to Us.

"You" (Entity) means any Legal Entity on behalf of whom a Contribution has
been received by Us. "Legal Entity" means an entity which is not a natural
person. "Affiliates" means other Legal Entities that control, are controlled
by, or are under common control with that Legal Entity. For this definition,
"control" means (i) the power, direct or indirect, to cause the direction or
management of such Legal Entity, whether by contract or otherwise, (ii)
ownership of fifty percent (50%) or more of the outstanding shares or
securities which vote to elect management or other persons who direct such
...
Copyright in the entire work of authorship, follow the instructions in
`CONTRIBUTING.md` before submitting it.
...
"Material" means the work of authorship made available by Us to third parties.
After You Submit the Contribution, it may be included in the Material.

"Submit" means any form of electronic, verbal, or written communication sent
to Us or our representatives, including electronic mailing lists, source code
control systems, issue tracking systems, and pull requests managed by or on
behalf of Us for discussing and improving the Material, but excluding
communication conspicuously marked or otherwise designated in writing by You
...
(b) To the maximum extent permitted by relevant law, You grant to Us a
...
combination). This license is granted only to the extent that exercise of the
licensed rights infringes such patent claims and is conditioned upon
...
As a condition on exercising this right, We agree to also license the
Contribution under the terms of the license or licenses which We are using for
the Material on the Submission Date. Heliopause currently uses Apache-2.0;
this option preserves future dual licensing, commercial editions, and
relicensing while preserving the applicable outbound license promise.

No additional outbound Media license is selected by this Agreement. Any Media
license must be identified and agreed separately before inclusion.
...
of rights which You have made to third parties, including Your employer. If
You are an employee, You have had Your employer approve this Agreement or
sign the entity version of this document. If You are less than eighteen years
old, please have a parent or guardian sign the Agreement.
...
(d) You have followed the third-party and mixed-contribution instructions in
`CONTRIBUTING.md` if You do not own the Copyright in the entire work of
...
6.4 Failure of either party to require performance by the other party in one
situation does not affect the right to require performance at any time in the
future and is not a waiver of the provision.

6.5 If any provision is void and unenforceable, it will be replaced to the
extent possible with a provision closest to the meaning of the original and
which is enforceable. The remaining terms apply to the maximum extent possible
under law.
...
Signature or electronic acceptance: ________________________________
...
`LICENSE` is the outbound license that grants users rights to use Heliopause.
This CLA is the inbound grant from a contributor to the Heliopause project. A
user may use Apache-2.0 code without signing this CLA; an external contributor
must satisfy the CLA process before their contribution is merged.

This document is based on the Harmony Combined Contributor Agreement Template
Version 1.0. It is not a substitute for legal advice. The governing
jurisdiction placeholder must be resolved before production public release.
