...
func TestValidateCurrentImports(t *testing.T) {
	...
	packages := []packageMetadata{
		...
		{ImportPath: modulePath + "/internal/policy", Imports: []string{modulePath + "/internal/core/domain", modulePath + "/internal/artifact/pypi"}},
		{ImportPath: modulePath + "/internal/artifact/npm", Imports: []string{"net/http", modulePath + "/internal/core/domain"}},
		{ImportPath: modulePath + "/internal/artifact/pypi", Imports: []string{"net/url", modulePath + "/internal/core/domain", modulePath + "/internal/runtimeidentity"}},
